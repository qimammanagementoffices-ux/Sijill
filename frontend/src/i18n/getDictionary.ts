...
export type Dictionary = {
  ...
  warehouseInvoices: {
    ...
    mixedTax: string;
    postConfirmTitle: string;
    postConfirmAction: string;
    removeLine: string;
    close: string;
    totalsAriaLabel: string;
    confirmDetails: string;
    errorInvoiceNumberRequired: string;
    errorVendorRequired: string;
    errorAtLeastOneLine: string;
    errorQuantityPositiveInteger: string;
    errorPriceNonNegative: string;
    errorTaxRange: string;
    errorDiscountRange: string;
    errorDiscountValueNonNegative: string;
    errorDiscountExceedsGross: string;
